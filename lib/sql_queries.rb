...
"Write your SQL query Here"	  "SELECT users.name, users.age, SUM(pledges.amount)
  FROM users
  INNER JOIN pledges
 ...
 def selects_the_titles_and_amount_over_goal_of_all_projects_that_have_met_their_funding_goal	def selects_the_titles_and_amount_over_goal_of_all_projects_that_have_met_their_funding_goal
"Write your SQL query Here"	  "SELECT projects.title, SUM(pledges.amount) - projects.funding_goal
    FROM projects
...
"Write your SQL query Here"	  "SELECT users.name, SUM(pledges.amount)
  FROM users
...
"Write your SQL query Here"	  "SELECT projects.category, pledges.amount
  FROM projects
  JOIN pledges ON projects.id = pledges.project_id
